...
export const renameFilesAndUpdateLinksInContent = (oldFilePathString, newFilePathString, force = false) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (var _d = true, pagesInDirectory_1 = __asyncValues(pagesInDirectory), pagesInDirectory_1_1; pagesInDirectory_1_1 = yield pagesInDirectory_1.next(), _a = pagesInDirectory_1_1.done, !_a;) {
